            ...
            >
                ...
                >
                    {value.map((item, index) => (
                        <Badge
                            ...
                            className={cn(
                                ...
                                "bg-gray-200 dark:bg-[#3a3a3a] text-gray-800 dark:text-gray-200",
                                "data-[active='true']:ring-2 data-[active='true']:ring-[#1DB954]",
                    ...
                    <Input
                        ...
                        className={cn(
                            "outline-0 border-none min-w-fit flex-1 h-8",
                            "bg-transparent text-gray-900 dark:text-white",
                            "focus-visible:outline-0 focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-0",
                            "placeholder:text-gray-500 dark:placeholder:text-gray-400 px-1",
                            "shadow-none",
